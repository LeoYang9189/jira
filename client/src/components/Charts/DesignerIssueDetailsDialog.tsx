        ...
        <Box display="flex" justifyContent="space-between" alignItems="center">
          <Box>
            <Typography variant="h6" component="div">
              {designerName} - 详细Issue列表
            </Typography>
            <Typography variant="body2" color="textSecondary" sx={{ mt: 0.5 }}>
              总工时: {totalWorkHours.toFixed(1)} 小时 | 包含 {issueDetails.length} 个Issue
            </Typography>
          </Box>
            ...
            <Table stickyHeader size="small">
              <TableHead>
                <TableRow>
                  ...
                  <TableCell sx={{ fontWeight: 600, backgroundColor: '#f8fafc' }}>工时(H)</TableCell>
                    ...
                    <TableCell>
                      <Tooltip title="在新窗口中打开Issue" arrow>
                        <IconButton 
                          size="small" 
                          onClick={() => {
                            // 这里可以根据实际JIRA域名配置跳转链接
                            window.open(`#issue-${issue.issue_key}`, '_blank');
                          }}
                        >
